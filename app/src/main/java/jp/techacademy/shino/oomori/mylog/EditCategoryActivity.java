    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // Category add
                // テキスト入力用Viewの作成
                final EditText editView = new EditText(EditCategoryActivity.this);
                AlertDialog.Builder dialog = new AlertDialog.Builder(EditCategoryActivity.this);
        ...
        // ListViewの設定
        categoryAdapter = new CategoryAdapter(EditCategoryActivity.this);
                ...
                if(position != 0) {
                    ...
                    builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            // 削除するカテゴリーを持つタスクを更新
                            RealmResults<MLog> targets = mRealm.where(MLog.class).equalTo("categoryID", category.getId()).findAll();
                            for (MLog targetMLog : targets) {
                                targetMLog.setCategoryId(0);
                            }
